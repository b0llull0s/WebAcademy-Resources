...
## Exploiting blind SQL injection by triggering conditional responses (Boolian Base)
...
## Inducing conditional responses by triggering SQL errors (Boolean Base)
...
## Exploiting blind SQL injection by triggering time delays(Time Base)
